...
public abstract class Pagamento implements Serializable {
	...
	public Pagamento(Integer id, TipoPagamento tipoPagamento, Pedido pedido) {
		super();
		this.id = id;
		this.tipoPagamento = (tipoPagamento==null) ? null : tipoPagamento.getCodigo();;
		this.pedido = pedido;
	}
	...
	public TipoPagamento getEstadoPagamento() {
		return TipoPagamento.toEnum(tipoPagamento);
	}

	public void setEstadoPagamento(TipoPagamento tipoPagamento) {
